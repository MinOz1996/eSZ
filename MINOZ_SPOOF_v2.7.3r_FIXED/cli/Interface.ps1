...
function Show-AegisMenu {
    ...
    function BTop { Write-Host "  " -NoNewline; Write-Host ($c_tl + ([string]$c_h * $W) + $c_tr) -ForegroundColor DarkMagenta }
    function BSep { Write-Host "  " -NoNewline; Write-Host ($c_ml + ([string]$c_h * $W) + $c_mr) -ForegroundColor DarkMagenta }
    function BBot { Write-Host "  " -NoNewline; Write-Host ($c_bl + ([string]$c_h * $W) + $c_br) -ForegroundColor DarkMagenta }
    ...
    Write-Host ""
    Write-Host ("  " + ([string]$c_h * 66)) -ForegroundColor DarkMagenta
    Write-Host ""
...
function Show-IdentityReport {
    ...
    Clear-Host
    Write-Host ""
    Write-Host ("  " + $c_tl + ([string]$c_h * 70) + $c_tr) -ForegroundColor DarkMagenta
    ...
    Write-Host ("  " + $c_bl + ([string]$c_h * 70) + $c_br) -ForegroundColor DarkMagenta
    Write-Host ""
