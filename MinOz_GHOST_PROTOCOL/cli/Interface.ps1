...
function Show-AegisMenu {
    ...
    Write-Host "    #          Effectiveness: 95-98% (User-mode Maximum)         #" -ForegroundColor Magenta
    Write-Host "    #                                                              #" -ForegroundColor Magenta
    Write-Host "    #          Version: 1.0.0 PRODUCTION                          #" -ForegroundColor Magenta
    Write-Host "    #          $currentDate                   #" -ForegroundColor Magenta
    ...
    Write-Host "(95-98% Effectiveness - All 5 Modules)" -ForegroundColor DarkGray
    
    Write-Host "    " -NoNewline
    Write-Host "[2] " -ForegroundColor Green -NoNewline
    Write-Host "STANDARD PROTECTION " -ForegroundColor Yellow -NoNewline
    Write-Host "(60-70% - Registry Only)" -ForegroundColor DarkGray
